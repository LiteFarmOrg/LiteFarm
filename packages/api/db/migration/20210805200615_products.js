...
exports.up = async function(knex) {
  ...
  await knex.raw('ALTER TABLE pest_control_task DROP CONSTRAINT pestcontrollog_target_disease_id_foreign');
  await knex.raw('ALTER TABLE pest_control_task DROP CONSTRAINT pestcontrollog_pesticide_id_foreign');
  await knex.raw(formatAlterTableEnumSql('pest_control_task', 'type', [
