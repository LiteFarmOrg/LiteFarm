...
const testCases = [
  {
    ...
    expectedResults: {
      ...
      LAST_12_MONTHS: { startDate: '2022-12-31', endDate: '2023-12-31' },
  ...
  },
  {
    ...
    expectedResults: {
      ...
      LAST_12_MONTHS: { startDate: '2023-01-01', endDate: '2024-01-01' },
      THIS_WEEK: { startDate: '2023-12-31', endDate: '2024-01-06' },
      LAST_WEEK: { startDate: '2023-12-24', endDate: '2023-12-30' },
  ...
  },
  {
    ...
    expectedResults: {
      ...
      LAST_12_MONTHS: { startDate: '2024-03-13', endDate: '2025-03-13' },
