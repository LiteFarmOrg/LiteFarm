...
import {expenseTypeSelector, expensesToEditSelector} from "../../../../Finances/selectors";
...
import {setSelectedEditExpense} from '../../../../Finances/actions'
  ...
  render() {
    ...
    return (
      <div className={defaultStyles.financesContainer}>
        <PageTitle backUrl='/expenses' title='Edit Expense (1 of 2)'/>
        <Alert variant="warning">
          Deselect a category will remove expenses under this category.
        </Alert>
