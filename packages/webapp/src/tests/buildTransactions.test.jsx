...
const allResults = [
  ...
  },
  {
    ...
    items: {
      ...
      TASK_TYPE: [{ time: 2, labourCost: 60, taskType: 'Transplant' }],
    },
  ...
  },
  {
    ...
    items: {
      ...
      TASK_TYPE: [{ time: 0.83, labourCost: 19.9, taskType: 'Clean' }],
    },
    note: 'FINANCES.TRANSACTION.LABOUR_EXPENSE',
  },
  {
  ...
  },
  {
    ...
    items: {
      ...
      TASK_TYPE: [{ time: 4, labourCost: 80, taskType: 'Transplant' }],
    },
    note: 'FINANCES.TRANSACTION.LABOUR_EXPENSE',
  },
  {
