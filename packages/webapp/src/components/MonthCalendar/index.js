...
function FullMonthCalendarView({
                                 date,
                                 stage
                               }) {
  ...
  const monthName = moment(targetDate)
  ...
  return (
    <>
      <div className={styles.stagesBox}>
        <div className={styles.flexStage} >
          <div
            ...
            style={{ backgroundColor: stageToColor[stage] }}
          />
      ...
      <div className={styles.calendarBox}>
        ...
        <div style={{ display: ' flex', flexDirection: 'column', paddingLeft: '20px', paddingBottom: '20px'}}>
          <div style={{
            flex: '1',
            marginTop: '20px',
            display: 'flex',
            ...
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>S</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>M</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>T</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>W</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>T</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>F</b></div>
            <div style={{ flex: '1 0 13%', alignSelf: 'center' }}><b>S</b></div>
          </div>
          <div style={{
            flex: '1',
            ...
            ))}
            {
              [ ...Array(numberOfDays) ].map((_, dayNumber) => (
                <div style={{ flex: '1 0 13%', marginTop: '10px', alignSelf: 'center' }}>
                    <span
                      style={{ backgroundColor: dayNumber + 1 === targetDate.getDate() && stageToColor[stage] }}
                      className={clsx(dayNumber + 1 === targetDate.getDate() && styles.targetDateFont)}>{dayNumber + 1}</span>
                </div>
              ))
            }
