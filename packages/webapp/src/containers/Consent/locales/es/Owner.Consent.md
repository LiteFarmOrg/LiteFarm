...
LiteFarm utiliza la información de administración que Ud. ingresa en la aplicación para generar información sobre los beneficios o impactos financieros, ambientales y sociales de sus decisiones de administración. Estos datos los volvemos anónimos para realizar investigaciones académicas no comerciales sobre sistemas de alimentación sostenibles. Debido a que estos datos son anonimizados cuando se utilizan en nuestra investigación, no pueden ser rastreados a usted ni a su granja. Estos datos incluyen:
