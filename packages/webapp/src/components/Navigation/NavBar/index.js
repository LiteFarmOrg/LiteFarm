...
export default function PureNavBar({ logo, children, steps, resetSpotlight, changeInteraction, isOneTooltipOpen, showSwitchFarm, tooltipInteraction, history}) {
  ...
  return (
    <div className={styles.navBar}>
      <div className={styles.actionItemContainer}>
        ...
        <PureProfileFloater showSwitchFarm={showSwitchFarm} closeInteraction={() => changeInteraction('profile')}
