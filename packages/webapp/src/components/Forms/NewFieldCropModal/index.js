		...
		return (
			<div>
				<div className={styles.buttonContainer}>
					<Button onClick={this.handleShow}>New Field Crop</Button>
				</div>
						...
						<FormGroup>
							...
							<div>
								<h4 style={{ textAlign: 'center' }}>
									Edit estimated price for the crop ({this.state.currencySymbol}/{this.state.estimated_unit})
								</h4>
								<FormGroup
								...
								>
									<FormControl
										type="number"
										placeholder={`Estimated Price (${this.state.currencySymbol}/${this.state
											.estimated_unit})`}
							...
							<div>
								{isByArea && (
									<h4 style={{ textAlign: 'center' }}>
										Edit estimated yield for the crop ({this.state.estimated_unit}/{this.state.area_unit_label}&sup2;)
									</h4>
								)}
								{!isByArea && (
									<h4 style={{ textAlign: 'center' }}>
										Edit estimated yield for the crop ({this.state.estimated_unit}/bed)
									</h4>
								)}
