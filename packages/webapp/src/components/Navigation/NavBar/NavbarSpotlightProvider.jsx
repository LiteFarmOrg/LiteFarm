  ...
  return <TourProviderWrapper steps={[
    {
      ...
      list: [t('NAVIGATION.SPOTLIGHT.EDIT_FARM_SETTING'), t('NAVIGATION.SPOTLIGHT.MAP_FARM'), t('NAVIGATION.SPOTLIGHT.MANAGE_EMPLOYEE')],
      position: 'bottom',
    ...
    },
    {
      ...
      contents: [t('NAVIGATION.SPOTLIGHT.YOU_CAN')],
      list: [t('NAVIGATION.SPOTLIGHT.MANAGE_TASK'), t('NAVIGATION.SPOTLIGHT.SEE_TASK'), t('NAVIGATION.SPOTLIGHT.COORDINATE_ACTIVITIES')],
      position: 'bottom',
      popoverStyles: { width: '240px' },
    ...
    },
    {
      ...
      list: [t('NAVIGATION.SPOTLIGHT.INFO'), t('NAVIGATION.SPOTLIGHT.TIPS'), t('NAVIGATION.SPOTLIGHT.LOG_OUT')],
      position: 'bottom',
      popoverStyles: { width: '240px' },
    },
  ]} open={open} onFinish={onFinish}>{children}</TourProviderWrapper>;
}
