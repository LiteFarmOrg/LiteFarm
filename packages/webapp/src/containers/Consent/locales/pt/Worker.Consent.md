...
Seu uso da LiteFarm é totalmente voluntário. Se você decidir usar a LiteFarm, poderá optar por excluir sua conta a qualquer momento, sem fornecer um motivo e sem qualquer outra ação por parte do pesquisador. Se quiser remover todos os seus dados da base de dados da LiteFarm, você poderá fazer isso enviando um e-mail com sua solicitação para data@litefarm.org.
&nbsp;
