...
const certifiers = [
  ...
  },
  {
    ...
    certifier_name: 'Asociación de Productores Orgánicos',
    certifier_acronym: 'APRO',
    supported: true,
  },
  {
    certification_type: 2,
  ...
  },
  {
    ...
    certifier_acronym: 'CAMPESINO',
    supported: true,
  },
  {
    certification_type: 2,
    certifier_name: 'Tijtoca Nemiliztli',
    certifier_acronym: 'TNAC',
    supported: true,
  },
  {
    certification_type: 2,
    certifier_name: 'Fundación para el Desarrollo Socioeconómico y Restauración Ambiental',
    certifier_acronym: 'FUNDESYRAM',
    supported: true,
  },
];
...
export const up = async function (knex) {
  ...
  const updatedCertifiers = currentCertifiers.map((certifier) => {
    const match = allCertifiers.find(
      ({ certifier_name, certifier_acronym }) =>
  ...
  return Promise.all(
    updatedCertifiers.map((updatedCertifier) => {
