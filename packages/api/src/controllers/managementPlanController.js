    ...
    return async (req, res) => {
      ...
      try {
        ...
        const managementPlanGraph = await ManagementPlanModel.query(trx)
          ...
          .withGraphFetched(
            'crop_management_plan.[planting_management_plans.[managementTasks.[task.[pest_control_task, irrigation_task, scouting_task, soil_task, soil_amendment_task, soil_amendment_task_product.[purpose_relationships], field_work_task, harvest_task, cleaning_task, locationTasks]], plant_task.[task.[locationTasks]], transplant_task.[task.[locationTasks]], bed_method, container_method, broadcast_method, row_method]]',
          )
          .modifyGraph(
