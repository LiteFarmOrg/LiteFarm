...
3. Check to see if you have pnpm (v9.15.9) installed. On a Mac use the command `pnpm -v`. If it is installed, the version will be reported. If you do not have it installed, or have a different version of pnpm installed, run `npm install -g pnpm@9.15.9` in a terminal.
