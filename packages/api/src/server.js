...
app
  ...
  .use('/soil_amendement_purpose', soilAmendmentPurposeRoute)
  .use('/soil_amendement_method', soilAmendmentMethodRoute)
  .use('/soil_amendement_fertiliser_type', soilAmendmentFertiliserTypeRoute)
  .use('/user', userRoutes)
