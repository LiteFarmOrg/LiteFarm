...
vi.mock('jsdom');
vi.mock('../src/middleware/acl/checkJwt.js', () =>
  vi.fn((req, res, next) => {
    req.auth = {};
...
describe('ManagementPlan Tests', () => {
  ...
  describe('Get && delete && put managementPlan', () => {
    ...
    describe('Get managementPlan', () => {
      const assetManagementPlans = (res, count) => {
        for (const management_plan of res.body) {
          ...
          expect([
            ...
            management_plan.crop_management_plan.planting_management_plans[0]
              .planting_method
          );
          if (
            management_plan.crop_management_plan.planting_method ===
            'BROADCAST_METHOD'
          ) {
            expect(
              management_plan.crop_management_plan.planting_management_plans[0]
            ...
            management_plan.crop_management_plan.planting_type ===
            'CONTAINER_METHOD'
          ) {
            expect(
              management_plan.crop_management_plan.planting_management_plans[0]
      ...
      it('Workers should get managementPlan by farm id', async (done) => {
        getRequest(
      ...
      it('Workers should get managementPlan by date', async (done) => {
        getRequest(
          `/management_plan/farm/date/${farm.farm_id}/${moment().format(
            'YYYY-MM-DD'
          )}`,
          { user_id: worker.user_id },
          (err, res) => {
      ...
      it('Workers should get managementPlan by id', async (done) => {
        getRequest(
          ...
          (err, res) => {
            expect(res.status).toBe(200);
            expect(
              res.body.crop_management_plan.planting_management_plans[1]
                .management_plan_id
      ...
      describe('Get managementPlan authorization tests', () => {
        ...
        it('Owner should get managementPlan by farm id', async (done) => {
          getRequest(
            `/management_plan/farm/${farm.farm_id}`,
        ...
        it('Manager should get managementPlan by farm id', async (done) => {
          getRequest(
            `/management_plan/farm/${farm.farm_id}`,
        ...
        it('Should get status 403 if an unauthorizedUser tries to get managementPlan by farm id', async (done) => {
          getRequest(
            `/management_plan/farm/${farm.farm_id}`,
        ...
        it('Circumvent authorization by modifying farm_id', async (done) => {
          getRequest(
            `/management_plan/farm/${farm.farm_id}`,
            {
              user_id: unAuthorizedUser.user_id,
      ...
      describe('Get harvested to date', () => {
        it('should get all the harvested quantities that come from completed harvest_tasks in the management_plan', async (done) => {
          ...
          const [harvestedPlantingManagementPlan] =
          ...
          getRequest(
            ...
            (err, res) => {
              ...
              const mp = res.body.find(
                (mp) =>
                  mp.management_plan_id ===
                  harvestedManagementPlan.management_plan_id
              );
    ...
    describe('Delete managementPlan', function () {
      ...
      it('should delete a managementPlan by owner', async (done) => {
        deleteRequest(
          `/management_plan/${transplantManagementPlan.management_plan_id}`,
          {},
          async (err, res) => {
      ...
      it('should delete a managementPlan by manager', async (done) => {
        deleteRequest(
          `/management_plan/${transplantManagementPlan.management_plan_id}`,
          { user_id: manager.user_id },
          async (err, res) => {
      ...
      it('should delete a managementPlan by extension officer', async (done) => {
        deleteRequest(
          `/management_plan/${transplantManagementPlan.management_plan_id}`,
      ...
      it('should return 403 if an unauthorized user tries to delete a managementPlan', async (done) => {
        deleteRequest(
          `/management_plan/${transplantManagementPlan.management_plan_id}`,
          { user_id: unAuthorizedUser.user_id },
          (err, res) => {
      ...
      it('should return 403 if a worker tries to delete a managementPlan', async (done) => {
        deleteRequest(
          `/management_plan/${transplantManagementPlan.management_plan_id}`,
          { user_id: worker.user_id },
          (err, res) => {
    ...
    describe('patch managementPlan', () => {
      ...
      it.skip('should be able to edit management plan', async (done) => {
      ...
      describe('patch managementPlan authorization tests', () => {
        ...
        //TODO: Owner test
        it('should edit and the area_used field by manager', async (done) => {
          const reqBody = getFakeManagementPlan();
        ...
        it('should return 403 when unauthorized user tries to edit managementPlan', async (done) => {
          const reqBody = getFakeManagementPlan();
          patchManagementPlanRequest(
            reqBody,
            { user_id: unAuthorizedUser.user_id },
        ...
        it('should return 403 when a worker tries to edit managementPlan', async (done) => {
          const reqBody = getFakeManagementPlan();
          patchManagementPlanRequest(
            reqBody,
            { user_id: worker.user_id },
    ...
    describe('Complete/abandon management plan', () => {
      ...
      it('Abandon management plan', async (done) => {
      ...
      it('Complete management plan', async (done) => {
      ...
      it('Complete management plan with completed and abandoned tasks', async (done) => {
        const reqBody = getCompleteReqBody();
      ...
      it('Complete management plan with deleted and completed tasks', async (done) => {
        const reqBody = getCompleteReqBody();
      ...
      it('Abandon management plan with one pending task that reference this management plan and another management_plan', async (done) => {
        const reqBody = getCompleteReqBody();
        ...
        abandonManagementPlanRequest(reqBody, {}, async (err, res) => {
          ...
          const deletedManagementPlan = await knex('management_tasks')
            .where(
              _pick(managementTaskToBeDeleted, [
      ...
      it('Abandon management plan with two pending task that reference this management plan and another management_plan', async (done) => {
        const reqBody = getCompleteReqBody(true);
        const [plantingManagementPlan] = await getFinalPlantingManagementPlan(
          transplantManagementPlan
        );
        ...
        const [managementTaskToKeep] = await mocks.management_tasksFactory({
          promisedManagementPlan: mocks.crop_management_planFactory({
            promisedFarm: [farm],
          }),
          promisedTask: [managementTaskToBeDeleted],
        });
        ...
        abandonManagementPlanRequest(reqBody, {}, async (err, res) => {
          ...
          const keptManagementTask2 = await knex('management_tasks')
            .where(
              _pick(taskToAbandon, ['planting_management_plan_id', 'task_id'])
            )
            .first();
          ...
          const abandonedTask = await knex('task')
            ...
            .first();
          expect(getDateInputFormat(abandonedTask.abandon_date)).toBe(
            reqBody.abandon_date
          );
          done();
        });
      });

      it('Abandon management plan with one pending task that reference this management plan and no location', async (done) => {
        const reqBody = getCompleteReqBody(true);
        const [plantingManagementPlan] = await getFinalPlantingManagementPlan(
          transplantManagementPlan
        );
        ...
        abandonManagementPlanRequest(reqBody, {}, async (err, res) => {
          ...
          const newTask = await knex('task')
            ...
            .first();
          expect(getDateInputFormat(newTask.abandon_date)).toBe(
            reqBody.abandon_date
          );
      ...
      it('Should return 400 when complete management plan with pending tasks', async (done) => {
        const reqBody = getCompleteReqBody();
        const [plantingManagementPlan] = await getFinalPlantingManagementPlan(
          transplantManagementPlan
        );
  ...
  describe('POST management plan', () => {
    ...
    async function expectPlantingMethodPosted(
      res,
      final_planting_method,
      initial_planting_method
    ) {
      ...
      if (!already_in_ground) {
        const { planting_management_plan_id } = await knex(
        ...
        const plant_task = await knex('plant_task')
          .where({ planting_management_plan_id })
          .first();
      ...
      const { planting_management_plan_id } = await knex(
        ...
        .where({
          management_plan_id: res.body.management_plan.management_plan_id,
          planting_task_type: needs_transplant
            ? 'TRANSPLANT_TASK'
            : 'PLANT_TASK',
        })
        .first();
    ...
    async function expectManagementGroupPosted(res, repeatBody) {
      ...
      //Get graphs
      const templateManagementPlan = await getManagementPlanGraph(
        management_plan_id
      );
      ...
      const bareBonesTemplateManagementPlan = getBareBonesManagementPlan(
        templateManagementPlan
      );
      ...
      const sortedFirstNewPlanDates = getSortedDates(
        getDatesFromManagementPlanGraph(firstNewPlan)
      );
      ...
      dateGroups.forEach((dateGroup) => {
        dateGroup.forEach((date, index) => {
          const nextNewDate = dateGroup[index + 1]
            ? new Date(dateGroup[index + 1])
            : null;
          if (!nextNewDate) {
            return;
          }
    ...
    it('should create a broadcast management plan with required data', async (done) => {
      postManagementPlanRequest(
        getBody('broadcast_method'),
        userFarm,
        async (err, res) => {
    ...
    it('should create a broadcast management plan with required data and assigned to an assignee', async (done) => {
      ...
      postManagementPlanRequest(request_body, userFarm, async (err, res) => {
        ...
        const task = await knex('task')
          .where({ task_id: plant_task.task_id })
          .first();
    ...
    it('should create a broadcast management plan with 100% planted', async (done) => {
    ...
    it('should create a broadcast management plan with transplant', async (done) => {
      postManagementPlanRequest(
        getBody('broadcast_method', 'container_method'),
        userFarm,
        async (err, res) => {
          await expectPlantingMethodPosted(
            res,
            'broadcast_method',
            'container_method'
          );
    ...
    it('should create a container management plan with required data', async (done) => {
      postManagementPlanRequest(
        getBody('container_method'),
        userFarm,
        async (err, res) => {
    ...
    it('should create a container management plan with transplant', async (done) => {
      postManagementPlanRequest(
    ...
    it('should create a rows management plan', async (done) => {
      postManagementPlanRequest(
        getBody('row_method'),
        userFarm,
        async (err, res) => {
    ...
    it.skip('should not allow multiple types of plantation', async (done) => {
    ...
    it('should copy an existing management plan with transplant', async (done) => {
      ...
      postManagementPlanRequest(
        ...
        async (err, res) => {
          ...
          expect(res.status).toBe(201);
          const { management_plan_id } = res.body.management_plan;
          const repeatBody = getRepeatBody(
            management_plan_id,
            start_dates,
            repeat_details
          );
          await postRepeatManagementPlanRequest(
            repeatBody,
            userFarm,
            async (err, res) => {
              if (err) {
