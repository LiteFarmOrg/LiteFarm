...
const AddFarm = () => {
  ...
  const handleScriptLoad = () => {
    ...
    // address.
    placesAutocompleteRef.current.setFields([
      'geometry',
      'formatted_address',
      'address_component',
    ]);
    ...
    placesAutocompleteRef.current.addListener(
      'place_changed',
      handlePlaceChanged
    );
...
function MapPinWrapper() {
  return (
    <MapPin
      style={{ display: 'absolute', transform: 'translate(-50%, -100%)' }}
    />
  );
}
