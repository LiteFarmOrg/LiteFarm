...
```
### Hookform trigger does not update errors properly when there is a required RadioGroup after triggered input field

[github discussion](https://github.com/react-hook-form/react-hook-form/discussions/5843)

###### Walk around: trigger validation twice
```js
