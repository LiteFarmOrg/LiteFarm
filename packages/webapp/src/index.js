...
import fieldSaga from './containers/LocationDetails/AreaDetailsLayout/FieldDetailForm/saga';
import gardenSaga from './containers/LocationDetails/AreaDetailsLayout/GardenDetailForm/saga';
import gateSaga from './containers/LocationDetails/PointDetailsLayout/GateDetailForm/saga';
import waterValveSaga from './containers/LocationDetails/PointDetailsLayout/WaterValveDetailForm/saga';
import naturalAreaSaga from './containers/LocationDetails/AreaDetailsLayout/NaturalAreaDetailForm/saga';
import barnSaga from './containers/LocationDetails/AreaDetailsLayout/BarnDetailForm/saga';
import surfaceWaterSaga from './containers/LocationDetails/AreaDetailsLayout/SurfaceWaterDetailForm/saga';
import greenhouseSaga from './containers/LocationDetails/AreaDetailsLayout/GreenhouseDetailForm/saga';
import ceremonialSaga from './containers/LocationDetails/AreaDetailsLayout/CeremonialAreaDetailForm/saga';
import residenceSaga from './containers/LocationDetails/AreaDetailsLayout/ResidenceDetailForm/saga';
import farmSiteBoundarySaga from './containers/LocationDetails/AreaDetailsLayout/FarmSiteBoundaryDetailForm/saga';
import fenceSaga from './containers/LocationDetails/LineDetailsLayout/FenceDetailForm/saga';
import bufferZoneSaga from './containers/LocationDetails/LineDetailsLayout/BufferZoneDetailForm/saga';
import watercourseSaga from './containers/LocationDetails/LineDetailsLayout/WatercourseDetailForm/saga';
