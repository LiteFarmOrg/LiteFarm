...
describe('Location tests', () => {
  ...
  describe('GET /location by farm', () => {
    ...
    test('should GET 2 fields linked to that farm', async () => {
      ...
      console.log(result);
      getLocationsInFarm({ user_id: user, farm_id: farm }, farm, (_err, res) => {
    ...
    test('should not get locations from farms Im not part of', async () => {
      ...
      await appendFieldToFarm(farm, 2);
      await appendFieldToFarm(anotherUserFarm.farm_id, 3);
      getLocationsInFarm({ user_id: user, farm_id: farm }, anotherUserFarm.farm_id, (_err, res) => {
  ...
  describe('DELETE /location ', () => {
    ...
    test('should delete field', async () => {
      ...
      deleteLocation({ user_id, farm_id }, field1.location_id, async (_err, res) => {
        expect(res.status).toBe(200);
  ...
  describe('POST /location', () => {
    ...
    describe('Authorization', () => {
      Object.keys(figureMapping).map((asset) => {
        test(`should allow owner to create a ${asset}`, async () => {
          ...
          postLocation({ ...data, farm_id }, asset, { user_id, farm_id }, (_err, res) => {
            expect(res.status).toBe(200);
    ...
    test('should fail to create a barn if I send data for a field as well', () => {
    ...
    test('should fail to create a barn if I send a point instead of area', () => {
      const validData = locationData(locations.BARN);
    ...
    test('should fail to create a barn without area', () => {
      const validData = locationData(locations.BARN);
    ...
    test('should fail to create a field without a name', () => {
    ...
    test('should fail to create a field without grid_points', () => {
      const validData = locationData(locations.FIELD);
    ...
    test('should fail to create a field with only 2 grid_points', () => {
      const validData = locationData(locations.FIELD);
    ...
    test('should fail to create a location without asset', () => {
      const validData = locationData(locations.BARN);
    ...
    test('should fail to create a location without figure or asset', () => {
      const validData = locationData(locations.BARN);
      delete validData.barn;
    ...
    test('should fail to add  a user through the location graph', () => {
      const validData = locationData(locations.BARN);
      const data = {
        ...validData,
    ...
    test('should fail to modify  a user through the location graph', () => {
      const validData = locationData(locations.BARN);
      const data = {
        ...validData,
        updatedByUser: {
