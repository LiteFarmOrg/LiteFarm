  ...
  return (
    <div className={styles.headerContainer}>
      ...
      <div className={styles.headerAttributesContainer}>
        <Label>Variety: <Text className={styles.attributeText}> { crop_variety_name ?? t(`crop:${crop_translation_key}`) } </Text></Label>
      </div>
      <div className={styles.headerAttributesContainer}>
        <Label>Supplier: <Text className={styles.attributeText}> {supplierName} </Text></Label>
      </div>
