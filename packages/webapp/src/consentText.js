...
export const consentText = [
  ...
  },
  {
    ...
    body:
      'The LiteFarm team is comprised of scientists, researchers, designers and web developers at the University of British Columbia (UBC), and a participatory network of farmers and universities. This team is led by Dr. Zia Mehrabi (zia.mehrabi@ubc.ca) and Dr. Hannah Wittman (hannah.wittman@ubc.ca).',
  },
  {
    header: 'Who funds LiteFarm?',
    body:
      'LiteFarm is funded by the Centre for Sustainable Food Systems at UBC. We also have received funding from the Social Sciences and Humanities Research Council (SSHRC) and George Weston Limited. Our funders have no say in the operation and management of LiteFarm, and are unable to access to any of the personal information housed on the platform. Our funding model is currently donor and grant-driven.',
  },
  {
  ...
  },
  {
    ...
    body:
      'You have the right to know what data we have about you, request a copy of it, update and correct your data, request that we stop collecting your data, request a transfer of your data, or ask questions about any analyses using your data. For any such information or requests, contact mollie.mcdowell@ubc.ca.',
  },
  {
    header: 'What happens if you withdraw consent?',
    body:
      'If you withdraw your consent from this Informed Consent Form and Privacy Policy agreement, you will not be able to use the LiteFarm platform; we will delete your data from our database and will not use it for future research. If you plan to withdraw consent, please ensure that you back up your data.',
  },
  {
  ...
  },
  {
    ...
    body:
      'Your participation in LiteFarm is entirely voluntary. As a participant, you have the right to refuse to participate. If you decide to take part, you may choose to pull out of the Study at any time without giving a reason without any further action by the researcher.',
  },
  {
    header: 'Consent',
    body:
