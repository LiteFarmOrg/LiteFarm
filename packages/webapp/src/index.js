...
import fieldLocationSaga from './containers/AreaDetailsLayout/Field/saga';
import gateLocationSaga from './containers/PointDetailsLayout/Gate/saga';
import waterValveLocationSaga from './containers/PointDetailsLayout/WaterValve/saga';
import farmSiteBoundaryLocationSaga from './containers/AreaDetailsLayout/FarmSiteBoundary/saga';
...
sagaMiddleware.run(gateLocationSaga);
sagaMiddleware.run(waterValveLocationSaga);
sagaMiddleware.run(farmSiteBoundaryLocationSaga);
