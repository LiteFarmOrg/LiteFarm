...
class EditShiftOne extends Component {
  ...
  render() {
    const { new_start, new_end } = this.state;
    ...
    return (
      <div className={styles.logContainer}>
        ...
        <div className={styles.timeSection}>
          ...
          <div className={styles.timeRow}>
            ...
            <div className={styles.timeInput}>
              ...
              />{' '}
              <div className={styles.unit}>{this.props.t('SHIFT.EDIT_SHIFT.MINUTES')}</div>
            </div>
          </div>

          <div className={styles.wageContainer}>
            <div style={{ width: '70%' }}>
              {this.props.t('SHIFT.EDIT_SHIFT.WAGE_FOR_SHIFT')} ({symbol}/hr):{' '}
            </div>
            <div style={{ width: '25%' }}>
              <input
                type="number"
        ...
        <div className={styles.subTitle}>{this.props.t('SHIFT.EDIT_SHIFT.TASKS_FOR_SHIFT')}.</div>
        <Alert variant="warning">{this.props.t('SHIFT.EDIT_SHIFT.TASKS_SELECTED')}.</Alert>
