...
const Details = React.lazy(() => import('../containers/Animals/AnimalDetails'));
...
const AnimalsRoutes = ({ isCompactSideMenu }) => (
  <Switch>
    ...
    />
    <Route
      path={createAnimalDetailsUrl(':id')}
      exact
      render={(props) => <Details isCompactSideMenu={isCompactSideMenu} {...props} />}
    />
  </Switch>
);
