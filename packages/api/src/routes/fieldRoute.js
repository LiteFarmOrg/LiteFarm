...
router.get('/farm/:farm_id', hasFarmAccess, checkScope(['get:fields']), fieldController.getFieldByFarmID());
...
router.delete('/:id', hasFarmAccess, checkOwnership('field'), checkScope(['delete:fields']), fieldController.delField());
