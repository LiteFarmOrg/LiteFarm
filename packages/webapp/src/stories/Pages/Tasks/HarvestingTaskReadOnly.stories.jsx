...
Metric.play = async ({ canvasElement }) => {
  ...
  await harvestQuantityTest.selectedUnitToBeInTheDocument('kg');
  await harvestQuantityTest.visibleInputToHaveValue(14.97);
  await harvestQuantityTest.hiddenInputToHaveValue(14.968536);
  await harvestQuantityTest.visibleInputAndComboxIsDisabled();
  ...
  await harvestUseQuantityTest0.selectedUnitToBeInTheDocument('kg');
  await harvestUseQuantityTest0.visibleInputToHaveValue(13.61);
  await harvestUseQuantityTest0.hiddenInputToHaveValue(13.60776);
  await harvestUseQuantityTest0.visibleInputAndComboxIsDisabled();
  ...
  await harvestUseQuantityTest1.selectedUnitToBeInTheDocument('kg');
  await harvestUseQuantityTest1.visibleInputToHaveValue(2.27);
  await harvestUseQuantityTest1.hiddenInputToHaveValue(2.26796);
  await harvestUseQuantityTest1.visibleInputAndComboxIsDisabled();
};
...
Imperial.play = async ({ canvasElement }) => {
  const harvestQuantityTest = new UnitTest(canvasElement, 'harvest-quantity', harvestAmounts);
  await harvestQuantityTest.selectedUnitToBeInTheDocument('lb');
  await harvestQuantityTest.visibleInputToHaveValue(
  ...
  await harvestUseQuantityTest0.selectedUnitToBeInTheDocument('lb');
  await harvestUseQuantityTest0.visibleInputToHaveValue(
  ...
  await harvestUseQuantityTest1.selectedUnitToBeInTheDocument('lb');
  await harvestUseQuantityTest1.visibleInputToHaveValue(
