...
Reconhecemos as lacunas no acesso dos agricultores aos serviços de tecnologia digital, as baixas taxas de adoção e a necessidade expressa pelos agricultores de combinar uma série de serviços de gerenciamento de dados agrícolas em uma única plataforma não comercial. Queremos desenvolver uma solução que ajude os agricultores a operar seus negócios de forma mais sustentável do ponto de vista financeiro e ecológico e que também contribua para o avanço da ciência da sustentabilidade.
...
- Informação sobre da exploração: diferentes tipos de localização na propriedade, incluindo tamanho, nome, cultivos plantados nos campos, tarefas atribuídas a áreas, se é orgânico ou não, e outros atributos específicos do tipo de campo;
...
- Informações sobre o solo: localização; profundidade; textura; porcentagem de potássio, fósforo, nitrogênio, matéria orgânica, carbono orgânico, carbono inorgânico, carbono total, enxofre, cálcio, magnésio, sódio, zinco, manganês, ferro, cobre, boro; capacidade de troca catiônica (CEC); pH; densidade aparente.

- Dados de sensores, como conteúdo de água e temperatura do solo, que você, o agricultor, encaminha para o aplicativo por meio da integração do LiteFarm com sensores de terceiros
...
- Para melhorar os serviços de visualização de dados agrícolas que fornecemos a você: Conforme descrito acima, usamos seus dados de uso (ou seja, informações gerais sobre como você interage com a plataforma LiteFarm) para melhorar a plataforma LiteFarm e os serviços que ela oferece.
...
Embora tenhamos feito todos os esforços razoáveis para garantir que nosso aplicativo seja seguro e forneça as informações mais precisas possíveis para ajudá-lo a gerenciar sua fazenda, reconhecemos que o uso do LiteFarm traz riscos para você e sua operação agrícola e pode conter erros ou imprecisões de conteúdo e riscos de segurança. Os riscos associados a isso incluem perda potencial de produção, receita ou lucro, incapacidade de uso, interrupção ou atraso de serviços, perda, dano, corrupção ou recuperação de dados, ou violação de dados ou da segurança do sistema, que podem resultar do uso do aplicativo LiteFarm. Não aceitamos responsabilidade por esses riscos. Se tiver alguma preocupação e não puder consentir com a possibilidade de ocorrência desses riscos, não assine o formulário de consentimento no final desta página nem se registre para usar este produto. Nos casos de riscos iminentes conhecidos (como datas conhecidas de perda de serviços), faremos todo o possível para avisá-lo como usuário, para que você possa tomar as precauções necessárias para reduzir o risco (por exemplo, fazer backup de seus dados).
