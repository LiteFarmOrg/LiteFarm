...
Metric.play = async ({ canvasElement }) => {
  ...
  await plantingDepthTest.testVisibleValue(1);
  await plantingDepthTest.testHiddenValue(0.01);
  await plantingDepthTest.testSelectedUnit('cm');
  await rowWidthTest.testVisibleValue(50);
  await rowWidthTest.testHiddenValue(0.5);
  await rowWidthTest.testSelectedUnit('cm');
  await rowSpacingTest.testVisibleValue(35);
  await rowSpacingTest.testHiddenValue(0.35);
  await rowSpacingTest.testSelectedUnit('cm');
};
...
Imperial.play = async ({ canvasElement }) => {
  ...
  await plantingDepthTest.testVisibleValue(
    plantingDepthTest.convertDBValueToDisplayValue(0.01, 'in'),
  );
  await plantingDepthTest.testHiddenValue(0.01);
  await plantingDepthTest.testSelectedUnit('in');
  await rowWidthTest.testVisibleValue(rowWidthTest.convertDBValueToDisplayValue(0.5, 'ft'));
  await rowWidthTest.testHiddenValue(0.5);
  await rowWidthTest.testSelectedUnit('ft');
  await rowSpacingTest.testVisibleValue(rowSpacingTest.convertDBValueToDisplayValue(0.35, 'ft'));
  await rowSpacingTest.testHiddenValue(0.35);
  await rowSpacingTest.testSelectedUnit('ft');
};
