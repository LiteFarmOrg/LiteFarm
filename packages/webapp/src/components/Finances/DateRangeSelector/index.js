  ...
  render() {
    ...
    return (
      <div className={styles.rangeContainer}>
        <InfoBoxComponent customStyle={{float:'right'}} title={'Date Range Help'} body={'Select the date range to create a financial report for your farm for a given time window.'}/>
