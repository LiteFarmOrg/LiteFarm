...
Metric.play = async ({ canvasElement }) => {
  ...
  await waterUsageTest.testVisibleValue(1000);
  await waterUsageTest.testHiddenValue(1);
};
...
Imperial.play = async ({ canvasElement }) => {
  ...
  await waterUsageTest.testVisibleValue(waterUsageTest.convertDBValueToDisplayValue(1, 'gal'));
  await waterUsageTest.testHiddenValue(1);
};
