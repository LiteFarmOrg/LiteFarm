...
module.exports = (data, exportId, from_date, to_date, farm_name, measurement) => {
  return XlsxPopulate.fromBlankAsync()
    .then((workbook) => {
      ...
      sheet.range('A1:L1').merged(true).style({ ...defaultStyles, fontSize: 14, bold: true });
      ...
      sheet.range(`A6:L${lastLineNumber}`).style({ ...defaultStyles, fill: undefined, border: false });
