...
if (
  ...
  hostNameSplit[1] === 'ngrok'
) {
  URI = VITE_NGROK_API;
} else if (import.meta.env.API_URL?.length) {
  ...
  } else if (import.meta.env.MODE === 'integration') {
...
export const weatherAPIKey = import.meta.env.OPEN_WEATHER_APP_ID;
