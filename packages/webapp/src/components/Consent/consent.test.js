...
describe('Consent View', () => {
  ...
  it('renders correctly with given props', () => {
    ...
    render(<PureConsent onSubmit={fakeFunc} onGoBack={fakeFunc} checkboxArgs={{}} text={'PureConsentTest'} disabled={false} />)
  ...
  it('calls on submit when continue button is clicked', () => {
    ...
    render(<PureConsent onSubmit={mockSubmit} onGoBack={mockGoBack} checkboxArgs={{}} text={'Terms'} disabled={false} />)
  ...
  it('disables continue button if disabled prop is true', () => {
    const mockSubmit = jest.fn();
    const mockGoBack = jest.fn();
    render(<PureConsent onSubmit={mockSubmit} onGoBack={mockGoBack} checkboxArgs={{}} text={'Terms'} disabled={true} />)
    fireEvent.click(screen.getByText(/continue/i));
